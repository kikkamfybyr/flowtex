          ...
          {sides.map((side) => (
            <div key={side.id} className="inline-reagent">
              <div style={{ display: 'inline-grid', alignItems: 'center', justifyItems: 'center' }}>
                <span style={{ visibility: 'hidden', gridArea: '1 / 1', whiteSpace: 'pre', padding: 0, fontSize: '12px' }}>
                  {side.text || '横追加'}
                </span>
                <input 
            ...
            <div style={{ width: '100% '}}>
              ...
              {branchReagents.map((r: any) => (
                <div key={r.id} className="inline-reagent">
                  <div style={{ display: 'inline-grid', alignItems: 'center', justifyItems: 'center' }}>
                    <span style={{ visibility: 'hidden', gridArea: '1 / 1', whiteSpace: 'pre', padding: 0, fontSize: '11px' }}>
                      {r.text}
                    </span>
                    <input
                      className="reagent-input"
